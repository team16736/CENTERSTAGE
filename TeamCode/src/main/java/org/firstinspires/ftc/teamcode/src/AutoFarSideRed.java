...
@Autonomous(name = "AutoFarSideRed")
/*
This the far side red, Mel
 */
public class AutoFarSideRed extends HelperActions {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            if (propPlace == "left") {
                ...
                // drives to the board to place pixel
                driveToBoard(placer, -52, 18,-37, 90);
                // places pixel and parks
                placeAndPark(placer);
    ...
    */
    ...
    private void placePixelRight(PlacerActions placer) {
        ...
        gyroActions.initEncoderGyroDriveStateMachine(speed, 7, angle);
        while (gyroActions.encoderGyroDriveStateMachine(speed, 7, angle)) ;
        ...
        gyroActions.initEncoderGyroStrafeStateMachine(speed, 28, true);
    ...
    private void placeAndPark(PlacerActions placer) {
        ...
        gyroActions.encoderGyroStrafeStateMachine(speed, 19, false);
        while (gyroActions.encoderGyroStrafeStateMachine(speed, 19, false)) ;
    }
}