...
public class AutoParameters {
    ...
    public static int PIXEL_DROP_HEIGHT_HIGH = -1225;
    ...
    public static boolean BOARDSIDE_RED_HAS_PIXEL = true;
    //default = true
    ...
    //default = 400
    public static boolean BOARDSIDE_BLUE_HAS_PIXEL = true;
    ...
    //default = true
    public static int AUDIENCE_RED_PARK_STRAFE_DISTANCE = 24;
    //default = 24
